...
<section class="section body">
  ...
  <h1>Solicitud de Paquete</h1>
  <br>
  <form action="02insertar.php" method="POST">
  <div class="field">
  ...
  <p><strong>Plan de Paquete</strong></p>
  <p>Plan ----- Velocidad --- Tarifa (Bs) - Casillas</p>
  
  <div class="select is-rounded is-small">
  <select name="planes" id="planes" class="planes">
    <option></option>
    <option>[Internet + TV] -- [5 Mbs] -- [370.00] -- [3]</option>
    <option>[Internet + TV] -- [15 Mbs] -- [440.00] -- [3]</option>
    <option>[Internet + TV] -- [20 Mbs] -- [470.00] -- [3]</option>
    <option>[Internet + TV] -- [25 Mbs] -- [540.00] -- [3]</option>
    <option>[Internet + TV] -- [30 Mbs] -- [440.00] -- [3]</option>
    <option>[Internet + TV] -- [35 Mbs] -- [510.00] -- [3]</option>
  </select>
</div>
