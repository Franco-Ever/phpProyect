    ...
    if (empty($_POST['latitud'])) {
        ...
        No especifico la Direccion
            ...
            echo"<div class='container'><a href='./Solicitud.php' class='button is-primary is-rounded'>Volver a Intentarlo</a></div>";
            echo "<script>alert('Hubo algunos errores al enviar la solicitud');</script>";
            exit;
            
    }

    $sql = "INSERT INTO solicitud VALUES('$identidades','$planes','$nombres','$apellidos','$razones','$correos','$telefonofijo','$telefonocelular','$telefonooficina','$celularoficina','$fechacontratacion','$latitud','$longitud')";
