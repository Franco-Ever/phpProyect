...
<html lang="en">
  ...
  <div id="navbarBasicExample" class="navbar-menu ">
    <div class="navbar-end opciones">
      ...
      <a v class="navbar-item opciones" style="text-decoration: none;">
        Sobre Nosotros
      </a>
    </div>
...
<section class="section body">
  ...
  <h1>Solicitud de Tv Satelital</h1>
  <br>
  <form action="03insertar.php" method="POST">
  <div class="field">
  <label class="label">Documento de Identidad</label>
  <div class="control">
    <input class="input" type="text" name="identidades" id="identidades" placeholder="C.I">
  </div>
  </div>
  <p><strong>Plan de Tv Satelital</strong></p>
  <p>Plan ------------- Tarifa (Bs) - Casillas</p>
  
  <div class="select is-rounded is-small">
  <select name="planes" id="planes" class="planes">
    <option></option>
    <option>[COMERCIAL DIGITAL] -- [60.00] -- [3]</option>
    <option>[STAR PREMIUM] -------- [50.00] -- [3]</option>
    <option>[HBO PREMIUM] -------- [50.00] -- [3]</option>
    <option>[DUO PREMIUM] -------- [70.00] -- [3]</option>
    <option>[ADULTOS] --------------- [40.00] -- [3]</option>
  </select>
</div>
