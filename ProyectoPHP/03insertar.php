    ...
    $sql = "INSERT INTO tvsolicitud VALUES('$identidades','$planes','$nombres','$apellidos','$razones','$correos','$telefonofijo','$telefonocelular','$telefonooficina','$celularoficina','$fechacontratacion','$latitud','$longitud')";
