...
<br><br><br><br>
<h1 class="texto1">No te pierdas las series más populares de Netflix, Contrata ya tu plan!</h1>
</section>
  ...
  <article class="media deta">
    <div class="media is-cente">
      <figure class="image is-328x328 img">
        <img src="./img/tv.jpg" alt="Image">
      </figure>
    </div>
    <div class="media-content">
      <div class="content">
        <h1>COMERCIAL DIGITAL</h1>
        <p>Bs. 60.00</p>
        <p>125 Canales</p>
        <p><strong>Canales</strong>SD: 64 HD:61</p>
        <br>
        ...
        <p>
          ...
          <a href="tvsolicitud.php" class="btn btn-outline-success" >
            Solicitar
          </a>
        </p>
        <div class="collapse info" id="collapseExample1">
          <div class="card card-body">
            <h1>Detalles de Servicio:</h1>
            <p><strong>Ciudad:</strong>Cochabamba</p>
            <h1><strong>Tarifa Mensual:</strong><strong style="color: red;">Bs. 60.00</strong></h1>
            <p><strong>N° Canales:</strong>125 canales</p>
            <p><strong>Canales:</strong>SD: 64 HD: 61</p>
            <p><strong>Incluye:</strong>1 Equipo Digital</p>
            <p><strong>Tecnología:</strong>Satelital</p>
            <p><strong>Tipo de Servicio:</strong>EMPRESARIAL</p>
          </div>
        </div>
  ...
  <article class="media deta1">
    ...
    <div class="media-content">
      <div class="content">
        ...
        <p>Bs. 50.00</p>
        <p>7 Canales</p>
        <p><strong>Canales</strong>HD: 7</p>
        <br>
        <p>
          <a class="btn btn-outline-secondary" data-bs-toggle="collapse" href="#collapseExample2" role="button" aria-expanded="false" aria-controls="collapseExample">
            Más Información
          </a>
          <a href="tvsolicitud.php" class="btn btn-outline-success" >
            Solicitar
        ...
        <div class="collapse" id="collapseExample2">
          <div class="card card-body">
            <h1>Detalles de Servicio:</h1>
            <p><strong>Ciudad:</strong>Cochabamba</p>
            <h1><strong>Tarifa Mensual:</strong><strong style="color: red;">Bs. 50.00</strong></h1>
            <p><strong>N° Canales:</strong>7 Canales</p>
            <p><strong>Canales:</strong>HD: 7 STAR HD</p>
            <p><strong>Tecnología:</strong>Satelital</p>
            <p><strong>Tipo de Servicio:</strong>EMPRESARIAL</p>
          </div>
        </div>
  ...
  <article class="media deta">
    ...
    <div class="media-content">
      <div class="content">
        ...
        <p>Bs. 50.00</p>
        <p>11 Canales</p>
        <p><strong>Canales</strong>HD: 11</p>
        <br>
        <p>
          <a class="btn btn-outline-secondary" data-bs-toggle="collapse" href="#collapseExample3" role="button" aria-expanded="false" aria-controls="collapseExample">
            Más Información
          </a>
          <a href="tvsolicitud.php" class="btn btn-outline-success" >
            Solicitar
        ...
        <div class="collapse" id="collapseExample3">
          <div class="card card-body">
            ...
            <p><strong>Ciudad:</strong>Cochabamba</p>
            <h1><strong>Tarifa Mensual:</strong><strong style="color: red;">Bs. 50.00</strong></h1>
            <p><strong>N° Canales:</strong>11 Canales</p>
            <p><strong>Canales:</strong>HD: 11</p>
            <p><strong>Tecnología:</strong>Satelital</p>
            <p><strong>Tipo de Servicio:</strong>EMPRESARIAL</p>
          </div>
  ...
  <article class="media deta1">
    ...
    <div class="media-content">
      <div class="content">
        ...
        <p>Bs. 70.00</p>
        <p>14 Canales</p>
        <p><strong>Canales</strong>7 Star Premium + 7 HBO Premium</p>
        <br>
        <p>
          <a class="btn btn-outline-secondary" data-bs-toggle="collapse" href="#collapseExample4" role="button" aria-expanded="false" aria-controls="collapseExample">
            Más Información
          </a>
          <a href="tvsolicitud.php" class="btn btn-outline-success" >
            Solicitar
        ...
        <div class="collapse" id="collapseExample4">
          <div class="card card-body">
            <h1>Detalles de Servicio:</h1>
            <p><strong>Ciudad:</strong>Cochabamba</p>
            <h1><strong>Tarifa Mensual:</strong><strong style="color: red;">Bs. 70.00</strong></h1>
            <p><strong>N° Canales:</strong>14 Canales </p>
            <p><strong>Canales:</strong>7 Star Premium+ 7 HBO Premium</p>
            <p><strong>Tecnología:</strong>Satelital</p>
            <p><strong>Tipo de Servicio:</strong>EMPRESARIAL</p>
          </div>
  ...
  <article class="media deta">
    ...
    <div class="media-content">
      <div class="content">
        ...
        <p>Bs. 40.00</p>
        <p>2 Canales</p>
        <p><strong>Canales</strong>HD: 1 SD:1</p>
        <br>
        <p>
          <a class="btn btn-outline-secondary" data-bs-toggle="collapse" href="#collapseExample5" role="button" aria-expanded="false" aria-controls="collapseExample">
            Más Información
          </a>
          <a href="tvsolicitud.php" class="btn btn-outline-success" >
            Solicitar
        ...
        <div class="collapse" id="collapseExample5">
          <div class="card card-body">
            <h1>Detalles de Servicio:</h1>
            <p><strong>Ciudad:</strong>Cochabamba</p>
            <h1><strong>Tarifa Mensual:</strong><strong style="color: red;">Bs. 40.00</strong></h1>
            <p><strong>N° Canales:</strong>2 Canales</p>
            <p><strong>Canales:</strong>HD: 1 SD: 1</p>
            <p><strong>Canales:</strong>Venus + Playboy</p>
            <p><strong>Canales:</strong>1 VENUS + 1 PLAYBOY HD</p>
            <p><strong>Tecnología:</strong>Satelital</p>
            <p><strong>Tipo de Servicio:</strong>EMPRESARIAL</p>
          </div>
        </div>
